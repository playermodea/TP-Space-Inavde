...
public class EnemyCtrl : MonoBehaviour
{
        ...
        while (GameManager.instance.isGameover == false)
        {
            ...
            switch (enemyState)
            {
                ...
                case EnemyState.attack:
                    relativePos = playerTr.position - firePos.transform.position;
    ...
    void onFire()
    {
        ...
        Instantiate(enemyMissile, firePos.position, firePos.rotation);
        delayTime = 0;
    }

    void onPatrol()
    {
        if (Physics.Raycast(firePos.position, firePos.transform.forward, out coll, collDist))
        {
